...
<body class="blurBg-false" style="background-color:#EBEBEB">
  ...
  <form action="updateUri.php?id=<?php echo $id ?>" class="formoid-solid-blue" style="background-color:#FFFFFF;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post">
    <div class="title">
      <h2>Update User</h2>
    </div>
    <div class="element-input"><label class="title"></label>
      <div class="item-cont"><input class="large" type="text" name="id" placeholder="Id User" value="<?php echo $id; ?>" disabled /><span class="icon-place"></span></div>
    </div>
    <div class="element-input"><label class="title"></label>
      <div class="item-cont"><input class="large" type="text" name="name" value="<?php echo $name ?>" placeholder="Name User" /><span class="icon-place"></span></div>
    </div>
    <div class="element-password"><label class="title"></label>
      <div class="item-cont"><input class="large" type="password" name="password" value="<?php echo $pass ?>" placeholder="Password" /><span class="icon-place"></span></div>
    </div>
  ...
  <p class="frmd"><a href="http://formoid.com/v29.php">javascript form</a> Formoid.com 2.9</p>
  <script type="text/javascript" src="registeruser_files/formoid1/formoid-solid-blue.js"></script>
  <!-- Stop Formoid form-->
