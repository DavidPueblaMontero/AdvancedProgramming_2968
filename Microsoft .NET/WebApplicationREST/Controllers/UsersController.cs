...
namespace WebApplicationREST.Controllers
{
    public class UsersController : ApiController
    {
        ...
        public List<Users> Get()
        {
            ...
            {
                users.Add(new Users(0, null, null, null, null, ex.ToString()));
            }
            ...
            {
                users.Add(new Users(System.Convert.ToInt32(fetch_query["id_user"]), fetch_query["name_user"].ToString(), fetch_query["age_user"].ToString(), fetch_query["phone_user"].ToString(), fetch_query["address_user"].ToString(), null));
            }
            return users;
        }
        ...
        public Users Get(int id)
        {
            ...
            {
                users = new Users(0, null, null, null, null, ex.ToString());
            }
            ...
            while (fetch_query.Read())
            {
                users = new Users(System.Convert.ToInt32(fetch_query["id_user"]), fetch_query["name_user"].ToString(), fetch_query["age_user"].ToString(), fetch_query["phone_user"].ToString(), fetch_query["address_user"].ToString(), null);
            }
            return users;
        }
